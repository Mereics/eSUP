...
- Butonul ARM TTP223 este pe `GPIO9`; firmware-ul implementează long press 2 secunde pentru ARM și DISARM imediat la apăsare.
...
- Failsafe receiver: dacă nu primește control timp de 500 ms, throttle devine `1000`, steering `1500` și este trimisă comanda MAVLink DISARM o singură dată.
...
## TODO După Verificarea Wiringului

- Verificarea fizică a tuturor GPIO-urilor telecomenzii înainte de schimbarea pinout-ului în firmware.
- Stabilirea mapării finale pentru cele cinci semnale ale display-ului pe GPIO1..GPIO5.
- Confirmarea GPIO6/GPIO7/GPIO8 pentru Hall și MPU.
- Implementarea butonului course/track hold după confirmarea GPIO11.
- Implementarea butonului reverse după confirmarea GPIO12 și a canalelor fizice forward/reverse.
- Mutarea citirii bateriei telecomenzii pe GPIO13, montarea divizorului și activarea `TX_BATTERY_MONITOR_ENABLED`.
...
- Implementarea anulării cruise la reverse după implementarea modului reverse.
